...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/AoNonohsNv)
...
```sh
npx nx serve scoreboard
```

To create a production bundle:

```sh
npx nx build scoreboard
```

To see all available targets to run for a project, run:

```sh
npx nx show project scoreboard
```
